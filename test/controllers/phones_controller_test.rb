...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post phones_url, params: { phone: { Model: @phone.Model, Name: @phone.Name, Price: @phone.Price } }
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { Model: @phone.Model, Name: @phone.Name, Price: @phone.Price } }
